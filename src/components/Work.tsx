...
function ProjectCard({ project, index }: { project: typeof projects[0]; index: number }) {
  ...
  const CardContent = (
    ...
    >
      ...
      {/* Meta below card */}
      <div className="mt-4">
        <h3 className="font-display text-lg font-light italic" style={{ color: '#4B0507' }}>{project.title}</h3>
...
export default function Work() {
  ...
  return (
    <section id="work" className="py-20 md:py-32 px-5 sm:px-8 md:px-16 bg-cream">
      ...
      {/* 4 equal square projects in a row */}
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 sm:gap-6 md:gap-8 items-start">
